...
public class QbftBlockHeightManagerTest {
  ...
  public void preparedCertificateIncludedInRoundChangeMessageOnRoundTimeoutExpired() {
    ...
    //        messageFactory.createPrepare(roundIdentifier,
    // createdBlock.getQbftBlockHeader().getHash());
    ...
    // TODO JF FIX THIS
    //    final RoundChange receivedRoundChange = roundChange.decode(extraDataProvider);
    //
