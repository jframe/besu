...
public class BlockEncoderFixture {

  public BlockEncoder createBlockEncoder(final QbftBlock block) {
    return new BlockEncoder() {
      ...
      @Override
      public void writeTo(final QbftBlock pb, final RLPOutput rlpOutput) {
        // Do nothing
      }
    };
  }
