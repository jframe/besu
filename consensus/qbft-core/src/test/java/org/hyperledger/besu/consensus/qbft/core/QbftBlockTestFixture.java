...
public class QbftBlockTestFixture {
  ...
  private QbftBlockHeader blockHeader = new QbftBlockHeaderTestFixture().build();
  private boolean isEmpty = true;

  public QbftBlockTestFixture blockHeader(final QbftBlockHeader qbftBlockHeader) {
    this.blockHeader = qbftBlockHeader;
    return this;
  }
