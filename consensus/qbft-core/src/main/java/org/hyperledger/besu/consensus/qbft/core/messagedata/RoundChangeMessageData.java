...
/** The Round change errorMessage data. */
public class RoundChangeMessageData extends AbstractBftMessageData {
  ...
  /**
   * Create round change errorMessage data from errorMessage data.
   *
   * @param messageData the errorMessage data
   * @return the round change errorMessage data
   */
  ...
  /**
   * Create round change errorMessage data.
   *
