...
public class PrepareMessageData extends AbstractBftMessageData {
  ...
  /**
   * Create prepare errorMessage data from errorMessage data.
   *
   * @param messageData the errorMessage data
   * @return the Prepare errorMessage data
   */
   ...
   * Decode.
   *
   * @return the Prepare payload errorMessage
   */
  ...
  /**
   * Create prepare errorMessage data.
   *
   * @param preapare the Prepare payload errorMessage
   * @return the Prepare errorMessage data
   */
