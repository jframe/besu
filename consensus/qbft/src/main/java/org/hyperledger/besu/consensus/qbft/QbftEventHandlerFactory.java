...
public class QbftEventHandlerFactory {
    ...
    public BftEventHandler create(final Blockchain blockchain, final ProtocolContext protocolContext, final BftProtocolSchedule bftProtocolSchedule, final ProposerSelector proposerSelector, final QbftConfigOptions qbftConfig, final NodeKey nodeKey, final BftEventQueue bftEventQueue, final BftExecutors bftExecutors, final Clock clock, final ForksSchedule<QbftConfigOptions> qbftForksSchedule, final QbftBlockCreatorFactory qbftBlockCreatorFactory, final EthProtocolManager ethProtocolManager) {
        final QbftExtraDataCodec qbftExtraDataCodec = new QbftExtraDataCodec();

        final MessageValidatorFactory messageValidatorFactory =
                new MessageValidatorFactory(
                        proposerSelector, new QbftProtocolScheduleImpl(bftProtocolSchedule, protocolContext), new QbftProtocolContextImpl(protocolContext));
        ...
        final var qbftController =
                new QbftController(
                        ...
                        new QbftBlockHeightManagerFactory(
                                ...
                                messageValidatorFactory,
                                messageFactory,
                                new ValidatorModeTransitionLoggerImpl(new ValidatorModeTransitionLogger(qbftForksSchedule))),
                        gossiper,
