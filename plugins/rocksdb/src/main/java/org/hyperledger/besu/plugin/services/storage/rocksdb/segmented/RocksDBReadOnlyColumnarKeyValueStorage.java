...
public class RocksDBReadOnlyColumnarKeyValueStorage
    implements SegmentedKeyValueStorage<RocksDbSegmentIdentifier> {

  private static final Logger LOG =
      LoggerFactory.getLogger(RocksDBReadOnlyColumnarKeyValueStorage.class);
  ...
  public Transaction<RocksDbSegmentIdentifier> startTransaction() throws StorageException {
    return new Transaction<>() {
      @Override
      public void put(
          final RocksDbSegmentIdentifier segment, final byte[] key, final byte[] value) {}
