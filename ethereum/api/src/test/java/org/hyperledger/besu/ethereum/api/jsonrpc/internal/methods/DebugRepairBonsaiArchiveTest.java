...
public class DebugRepairBonsaiArchiveTest {

  @Test
  public void shouldReturnErrorWhenArchiverNotPresent() {
    final DebugRepairBonsaiArchive method = new DebugRepairBonsaiArchive(Optional.empty());
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "debug_repairBonsaiArchive", new Object[] {}));
  ...
  public void shouldReturnTrueWhenArchiverPresent() {
    ...
    final DebugRepairBonsaiArchive method = new DebugRepairBonsaiArchive(Optional.of(mockArchiver));
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "debug_repairBonsaiArchive", new Object[] {}));
    ...
    verify(mockArchiver).triggerRepair();
  }
  ...
  public void shouldReturnCorrectMethodName() {
    ...
    assertThat(method.getName()).isEqualTo("debug_repairBonsaiArchive");
  }
}
