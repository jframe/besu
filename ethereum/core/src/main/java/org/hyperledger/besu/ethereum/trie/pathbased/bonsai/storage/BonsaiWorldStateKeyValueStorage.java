...
public class BonsaiWorldStateKeyValueStorage extends PathBasedWorldStateKeyValueStorage
  ...
  public Optional<Bytes> getAccount(final Hash accountHash) {
    return getAccount(accountHash, Optional::empty);
  }

  public Optional<Bytes> getAccount(
      final Hash accountHash, final Supplier<Optional<BonsaiContext>> readContextSupplier) {
  ...
  public Optional<Bytes> getStorageValueByStorageSlotKey(
    ...
    return getStorageValueByStorageSlotKey(accountHash, storageSlotKey, Optional::empty);
  }
  ...
  public Optional<Bytes> getStorageValueByStorageSlotKey(
      ...
      final StorageSlotKey storageSlotKey) {
    return getStorageValueByStorageSlotKey(
        storageRootSupplier, accountHash, storageSlotKey, Optional::empty);
  }
  ...
  public static class Updater implements PathBasedWorldStateKeyValueStorage.Updater {
    ...
    public Updater removeAccountInfoState(final Hash accountHash) {
      flatDbStrategy.removeFlatAccount(
          worldStorage, composedWorldStateTransaction, accountHash, writeContextSupplier);
      return this;
    }
